      ...
      <div className="flex-1 ml-56">
        ...
        <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-20">
          ...
          <div className="flex items-center gap-3">
            <button onClick={loadAll} className="text-sm text-slate-500 hover:text-teal-600 font-medium transition-colors flex items-center gap-1.5">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-sm text-slate-500 hover:text-red-500 font-medium transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
